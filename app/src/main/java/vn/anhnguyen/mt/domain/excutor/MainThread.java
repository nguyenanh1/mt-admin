package vn.anhnguyen.mt.domain.excutor;
 ...
 * if an interactor needs to showLoading an object to the UI this can be used to make sure the showLoading method is called on the UI
 * thread.
 * <p/>
 */
